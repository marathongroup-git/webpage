...
import map from '../../assets/static/divisions/marathon-soluciones-cableado-es-MX.png'
import banner from '../../assets/static/divisions/banner2.jpg'
import img1 from '../../assets/static/brands/datwyler-marathongroup.png'
import img2 from '../../assets/static/brands/optral-logo.png'
...
const divisions = () => {
  return (
    <div className="divisionsPage">
      ...
      >
        <Title className="title --center --white">Cableado estructurado</Title>
        <Text className="text --center --white">
          Contamos con soluciones para Infraestructuras de tecnologías de la
          Información y Comunicación (TICs), Data Centers y Electrónica de red
          industrial, así como racks, gabinetes, sistemas de gestión de
          cableados y equipos de medición.
        </Text>
      </div>
