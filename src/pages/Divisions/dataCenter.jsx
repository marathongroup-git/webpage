...
import map from '../../assets/static/divisions/marathon-soluciones-datacenter-es-MX.png'
...
const divisions = () => {
  return (
    <div className="divisionsPage">
      ...
      >
        <Title className="title --center --white">Data center</Title>
        <Text className="text --center --white">
          Brindar soluciones complementarias entre sí, es de vital importancia
          para que un entorno funcione de manera óptima y eficaz. Por tal razón,
          nuestras marcas ofrecen distintos productos de la más alta calidad
          para ambientes de alto rendimiento como lo son los centros de datos.
        </Text>
      </div>
