...
import map from '../../assets/static/divisions/marathon-soluciones-ethernet-es-MX.png'
...
const divisions = () => {
  return (
    <div className="divisionsPage">
      ...
      >
        <Title className="title --center --white">Ethernet industrial</Title>
        <Text className="text --center --white">
          Los equipos activos dentro de una red son un pilar importante de la
          misma; ya que son los soportes para que una estructura sea funcional.
          Debido a ésto, el ofrecer productos que tengan un excelente desempeño,
          seguridad, productividad y eficiencia es de vital impotancia para
          poder ofrecer una solución integral.
        </Text>
      </div>
